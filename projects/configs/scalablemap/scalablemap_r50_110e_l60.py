...
fixed_ptsnum_per_gt_line = 17
fixed_ptsnum_per_pred_line = 3

point_cloud_range = [-15.0, -60.0, -3.0, 15.0, 60.0, 1.0]
...
dataset_type = 'SMPNuScenesSegLocalMapDataset'
